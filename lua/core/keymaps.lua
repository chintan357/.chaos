...
Map("n", "<leader><tab>k", "<cmd>tabfirst<cr>")
Map("n", "<leader><tab>j", "<cmd>tablast<cr>")
...
Map("n", "<leader>qh", ":cprev<CR>")
Map("n", "<leader>qj", ":clast<CR>")
Map("n", "<leader>qd", ":cclose<CR>")
...
Map({ "n", "x" }, "j", "v:count > 7 ? 'gjzz' : 'jzz'", { expr = true, silent = true })
Map({ "n", "x" }, "k", "v:count > 7 ? 'gkzz' : 'kzz'", { expr = true, silent = true })
